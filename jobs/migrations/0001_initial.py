# Generated by Django 3.0.8 on 2021-05-06 03:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_type', models.SmallIntegerField(choices=[(0, '技术类'), (0, '产品类'), (0, '运营类'), (0, '设计类')], verbose_name='职位类别')),
                ('job_name', models.CharField(max_length=250, verbose_name='职位名称')),
                ('job_city', models.SmallIntegerField(choices=[(0, 'New York'), (1, 'San Francisco'), (2, 'Boston')], verbose_name='工作地点')),
